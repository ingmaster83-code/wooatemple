# -*- coding: utf-8 -*-
"""detailCommon2 + detailIntro2 로 각 사찰의 상세정보 수집 (병렬)"""
import json
import os
import time
...
RAW_LIST = os.path.join(SCRIPT_DIR, "..", "_rawdata", "list_raw.json")
OUT = os.path.join(SCRIPT_DIR, "..", "_rawdata", "detail_raw.json")
