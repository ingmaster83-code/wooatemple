# -*- coding: utf-8 -*-
"""TourAPI areaBasedList2 로 역사관광지(A0201) 전체 수집 (cat3 필터 없음)
-> 유명 사찰들이 cat3=사찰 태그 없이 누락되는 문제를 피하기 위함"""
import json
import os
import time
...
OUT = os.path.join(os.path.dirname(__file__), "..", "_rawdata", "list_raw_all.json")
